...
const AdminNavbar = () => {
  return (
    ...
    <div id="Maindiv" className=" bg-red-600 flex justify-between items-center p-5 font-Anton ">
      ...
      <Link to ="/" className="">
        <li className="hover:text-shadow-lg/50 hover:text-amber-500"  >DASHBOARD</li>
      </Link>
      <Link to ="adminproduct" className="">
        <li className="hover:text-shadow-lg/50 hover:text-amber-500">PRODUCT</li>
      </Link>
      <Link to ="manageuser" className="">
        <li className="hover:text-shadow-lg/50 hover:text-amber-500">MANAGE USER</li>
      </Link>
